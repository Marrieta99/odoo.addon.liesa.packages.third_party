...
class ProductTemplate(models.Model):
    ...
    feed_asin = fields.Char(
        string='ASIN',
        compute='_compute_feed_asin',
        inverse='_inverse_feed_asin',
        store=True,
    ...
    @api.depends('product_variant_ids.feed_asin')
    def _compute_feed_asin(self):
        self._compute_template_field_from_variant_field('feed_asin')

    def _inverse_feed_asin(self):
        self._set_product_variant_field('feed_asin')
